...
set TRAIN_FLAGS=--lr 1e-5 --weight_decay 1e-3 --batch_size 24 --use_fp16 True --log_interval 500 --lr_anneal_steps 100000 --save_interval 5000
...
set path_to_model=%ROOT_PATH%/output/exp_%SETTING%/diffusion/model100000.pt
