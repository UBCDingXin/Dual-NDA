...
set dump_niqe_path="F:/LocalWD/CcGAN_TPAMI_NIQE/UTKFace/NIQE_filter_128x128/fake_data"
...
python main.py ^
    ...
    --setting_name %SETTING% --samp_batch_size 500 ^
    --niqe_filter ^
    --niqe_dump_path %dump_niqe_path% --niqe_nfake_per_label_burnin 1000 ^ %*