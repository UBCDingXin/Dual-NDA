...
wd = args.root_path
os.chdir(wd)
from utils import SimpleProgressBar, IMGs_dataset, compute_entropy, predict_class_labels
from models import *
...
if args.comp_FID:
    ...
    if args.dump_fake_for_NIQE:
        ...
        if args.dump_fake_img_path=="None":
            dump_fake_images_folder = save_images_folder + '/fake_images'
        else:
            dump_fake_images_folder = os.path.join(args.dump_fake_img_path, 'fake_images')
    ...
    if args.comp_IS_and_FID_only:
        ...
        with open(eval_results_logging_fullpath, 'a') as eval_results_logging_file:
            ...
            eval_results_logging_file.write("\n NITERS: {}; Radius: {}.  \n".format(args.niters_gan, args.FID_radius))
