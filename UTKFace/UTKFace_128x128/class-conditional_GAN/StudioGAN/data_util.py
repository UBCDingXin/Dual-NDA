...
class Dataset_(Dataset):
    ...
    def load_dataset(self):
        ...
        max_num_img_per_label_after_replica=2000
        max_num_img_per_label=200

        ## modified for ccgan's experiment
        print("Start loading {} h5 file...".format(self.data_name))
        data_filename = self.data_dir+ '/UTKFace_{}x{}.h5'.format(img_size, img_size)
        print(data_filename)
        ...
        if self.train: ## in train mode
            ...
            print("\n {} unique labels are split into {} classes".format(num_unique_labels, num_classes))
