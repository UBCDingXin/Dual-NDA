...
@REM set CKPT_G=./output/%GAN_NAME%/checkpoints/UK128-ReACGAN-train-2023_08_03_22_56_02/model=G-current-weights-step=20000.pth
@REM set CKPT_G_EMA=./output/%GAN_NAME%/checkpoints/UK128-ReACGAN-train-2023_08_03_22_56_02/model=G_ema-current-weights-step=20000.pth
