...
def parse_opts():
    ...
    parser.add_argument('--samp_filter_mae_percentile_threshold', type=float, default=0.9,
    ...
    parser.add_argument('--samp_filter_nfake_per_label_burnin', type=int, default=2000)
    parser.add_argument('--samp_filter_nfake_per_label', type=int, default=2000)
    ...
    parser.add_argument('--niqe_nfake_per_label_burnin', type=int, default=2000)
