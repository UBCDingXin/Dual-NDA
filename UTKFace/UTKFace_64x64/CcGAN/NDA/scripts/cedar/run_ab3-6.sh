...
gan_ckpt_path="${ROOT_PREFIX}/${METHOD_NAME}/baseline/output/CcGAN_SNGAN_soft_si0.041_ka3600.000_vanilla_nDs2_nDa1_nGa1_Dbs256_Gbs256/saved_models/ckpts_in_train/ckpt_niter_40000.pth"
...
python main.py \
    ...
    --nda_a 0.9 --nda_b 0 --nda_c 0.05 --nda_d 0.05 --nda_e 0 --nda_c_quantile $nda_c_quantile \
