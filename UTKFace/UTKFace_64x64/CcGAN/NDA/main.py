...
if args.comp_FID:
    ...
    # PreNetFID = encoder_eval().cuda()
    # PreNetFID = nn.DataParallel(PreNetFID)
    # checkpoint_PreNet = torch.load(os.path.join(args.eval_ckpt_path, 'ckpt_SimCLR_encoder_epoch200.pth'))
    # PreNetFID.load_state_dict(checkpoint_PreNet)
    ...
    if args.comp_IS_and_FID_only:
        ...
        dump_fid_ls_entropy_over_centers_filename = os.path.join(save_setting_folder, 'fid_ls_entropy_over_centers_niters{}'.format(args.niters_gan))
