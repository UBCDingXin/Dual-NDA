...
@REM @REM @REM ===================================================================================================
@REM set CKPT_G=./output/%GAN_NAME%/checkpoints/UK64-ReACGAN-train-2023_08_03_02_38_25/model=G-current-weights-step=40000.pth
@REM set CKPT_G_EMA=./output/%GAN_NAME%/checkpoints/UK64-ReACGAN-train-2023_08_03_02_38_25/model=G_ema-current-weights-step=40000.pth
