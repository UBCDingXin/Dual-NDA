...
class sagan_generator(nn.Module):
    ...
    def __init__(self, nz, dim_embed=128, nc=3, gene_ch=64):
        ...
        self.snlinear0 = snlinear(in_features=self.dim_z, out_features=gene_ch*16*4*4)
...
if __name__ == "__main__":
    ...
    netG = sagan_generator(nz=256, dim_embed=128, gene_ch=64).cuda() #131367044 parameters
    netD = sagan_discriminator(dim_embed=128, disc_ch=64).cuda() #162158402 parameters
