...
set niqe_dump_path="F:/LocalWD/CcGAN_TPAMI_NIQE/SteeringAngle/NIQE_filter_128x128/fake_data"
set NITERS=20000
...
python main.py ^
    ...
    --samp_batch_size 2000 ^
    --niqe_filter --niqe_dump_path %niqe_dump_path% --niqe_nfake_per_label_burnin 100 ^ %*


@REM niqe_nfake_per_label_burnin=100, 17740; niqe_nfake_per_label_burnin=500, 88700