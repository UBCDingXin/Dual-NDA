...
set ROOT_PATH=<Your_Path>/Dual-NDA/SteeringAngle/SteeringAngle_128x128/diffusion_models/ADM_G
set DATA_PATH=<Your_Path>/Dual-NDA/datasets/SteeringAngle
set EVAL_PATH=<Your_Path>/Dual-NDA/SteeringAngle/SteeringAngle_128x128/evaluation/eval_models
