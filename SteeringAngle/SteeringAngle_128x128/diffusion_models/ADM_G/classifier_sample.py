...
def main():
    ...
    #######################################################################################
    # data loader
    data_filename = args.data_dir + '/SteeringAngle_{}x{}.h5'.format(args.image_size, args.image_size)
    ...
    np.savetxt(args.root_dir + '/label_dist.csv', data_csv, delimiter=',')
    ...
    if args.comp_FID:
        ...
        Filename_PreCNNForEvalGANs_Diversity = os.path.join(args.eval_ckpt_path, 'ckpt_PreCNNForEvalGANs_ResNet34_class_epoch_20_seed_2020_classify_5_scenes_CVMode_False.pth')
        ...
        for i in range(num_eval_labels):
            ...
            dump_fake_images_filename = os.path.join(dump_fake_images_folder, '{:.6f}.h5'.format(curr_label))
            ...
            img_filename = os.path.join(dump_fake_images_folder, 'sample_{:.6f}.png'.format(curr_label))
