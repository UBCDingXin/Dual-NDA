...
set CKPT_G=./output/%GAN_NAME%/checkpoints/SA128-%GAN_NAME%-train-2023_08_06_22_10_49/model=G-current-weights-step=20000.pth
set CKPT_G_EMA=./output/%GAN_NAME%/checkpoints/SA128-%GAN_NAME%-train-2023_08_06_22_10_49/model=G_ema-current-weights-step=20000.pth
