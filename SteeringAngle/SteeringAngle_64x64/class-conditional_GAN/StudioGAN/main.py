...
def load_configs_initialize_training():
    ...
    parser.add_argument("-cfg", "--cfg_file", type=str, default="./configs/ReACGAN.yaml")
    parser.add_argument("-data", "--data_dir", type=str, default=None)
    parser.add_argument("-save", "--save_dir", type=str, default="./output/ReACGAN")
    parser.add_argument("-ckpt", "--ckpt_dir", type=str, default=None) ## load the generator and the discriminator from a checkpoint if possible
    ...
    parser.add_argument("--path_to_G", type=str, default="None")
    parser.add_argument("--path_to_G_ema", type=str, default="None")

    parser.add_argument('--eval_ckpt_path_FID', type=str, default='', help="intra-fid")
    ...
    parser.add_argument('--FID_radius', type=float, default=2)
    ...
    parser.add_argument('--dump_fake_img_path', type=str, default='None') 
