...
set CKPT_G=./output/%GAN_NAME%/checkpoints/SA64-ADCGAN_2-train-2023_08_06_15_57_32/model=G-current-weights-step=20000.pth
set CKPT_G_EMA=./output/%GAN_NAME%/checkpoints/SA64-ADCGAN_2-train-2023_08_06_15_57_32/model=G_ema-current-weights-step=20000.pth
