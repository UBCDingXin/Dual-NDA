...
@REM set niqe_dump_path="F:/LocalWD/CcGAN_TPAMI_NIQE/SteeringAngle/NIQE_64x64/fake_data"
@REM set NITERS=20000
@REM set Setting=niters20K
@REM python main.py ^
...
@REM     --comp_FID --samp_batch_size 2000 --dump_fake_for_NIQE --niqe_dump_path %niqe_dump_path% ^ %*

@REM --dump_fake_for_NIQE --niqe_dump_path %niqe_dump_path% 


set Setting=niters20K
set niqe_dump_path="F:/LocalWD/CcGAN_TPAMI_NIQE/SteeringAngle/NIQE_filter_64x64/fake_data"
set NITERS=20000
set Setting=niters20K
python main.py ^
    ...
    --samp_batch_size 500 ^
    --niqe_filter --niqe_dump_path %niqe_dump_path% --niqe_nfake_per_label_burnin 50 ^ %*