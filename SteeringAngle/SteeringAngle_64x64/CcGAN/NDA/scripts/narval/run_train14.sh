...
fake_data_path_1="${ROOT_PREFIX}/${METHOD_NAME}/baseline/output/SAGAN_soft_si0.029_ka1000.438_hinge_nDs2_nDa1_nGa1_Dbs512_Gbs512/bad_fake_data/niters20K/badfake_NIQE0.6_nfake17740.h5"
